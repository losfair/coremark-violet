...
#define GETMYTIME(_t)              (*_t = get_cycles())
...
CORETIMETYPE get_cycles() {
    /*
    CORETIMETYPE x = cycle_count;
    cycle_count += 1;
    return x;
    */
    
    CORETIMETYPE low = *time_low;
    CORETIMETYPE high = *time_high;
    return low | (high << 32);
}
